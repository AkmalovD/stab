...
export default function Tokyo() {
  ...
  const filteredScholarships = tokyoData.scholarships.filter(s =>
              ...
              <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-border-light dark:border-border-dark p-6 space-y-6">
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm font-bold text-gray-900 dark:text-white">
                      £{period === 'monthly' ? tokyoData.costOfLiving.rent : tokyoData.costOfLiving.rent * 12}
                    </span>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm font-bold text-gray-900 dark:text-white">
                      £{period === 'monthly' ? tokyoData.costOfLiving.food : tokyoData.costOfLiving.food * 12}
                    </span>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm font-bold text-gray-900 dark:text-white">
                      £{period === 'monthly' ? tokyoData.costOfLiving.transport : tokyoData.costOfLiving.transport * 12}
                    </span>
                  </div>
                </div>
                <div className="pt-4 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center">
                  ...
                  <div className="text-xl font-bold text-primary">
                    £{period === 'monthly' ? tokyoData.costOfLiving.total[0] : tokyoData.costOfLiving.total[0] * 12}
                    - £{period === 'monthly' ? tokyoData.costOfLiving.total[1] : tokyoData.costOfLiving.total[1] * 12}
                  </div>
                </div>
              </div>
            </section>
